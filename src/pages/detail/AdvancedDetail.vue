    ...
    >
        ...
        <a-card style="margin-top: 24px;" :bordered="false" title="用户信息">
            <detail-list>
                ...
                >
                <detail-list-item term="身份证"
                    >3321944288191034921</detail-list-item
                >
            ...
            <detail-list title="信息组">
                ...
                <detail-list-item term="该数据更新时间"
                    >2018-08-08</detail-list-item
                >
            ...
            <a-card type="inner" title="多层信息组">
                <detail-list title="组名称" size="small">
                    ...
                    <detail-list-item term="所属部门"
                        >XX公司-YY部</detail-list-item
                    >
                    <detail-list-item term="过期时间"
                        >2018-08-08</detail-list-item
                    >
