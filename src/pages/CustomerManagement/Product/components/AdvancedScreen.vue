    ...
    <div>
        ...
        >
            ...
            <div style="display: flex; justify-content: space-between;">
                ...
                >
                    <a-select-option value="1"> 产品名称 </a-select-option>
                    <a-select-option value="2"> 产品类型 </a-select-option>
                    <a-select-option value="3"> 产品编码 </a-select-option>
                    <a-select-option value="4"> 价格 </a-select-option>
                    <a-select-option value="5"> 产品描述 </a-select-option>
                    ...
                    <a-select-option value="10"> 单位 </a-select-option>
                    <a-select-option value="11"> 是否上下架 </a-select-option>
                </a-select>
                <div>包含</div>
                <a-input
                    style="width: 293px;"
