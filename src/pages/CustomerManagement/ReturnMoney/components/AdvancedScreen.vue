    ...
    <div>
        ...
        >
            ...
            <div style="display: flex; justify-content: space-between;">
                ...
                >
                    <a-select-option value="1"> 回款编号 </a-select-option>
                    <a-select-option value="2"> 客户名称 </a-select-option>
                    <a-select-option value="3"> 合同编号 </a-select-option>
                    <a-select-option value="4"> 期数 </a-select-option>
                    <a-select-option value="5"> 回款日期 </a-select-option>
                    <a-select-option value="6"> 回款金额 </a-select-option>
                    <a-select-option value="7"> 回款方式 </a-select-option>
                    <a-select-option value="8"> 备注 </a-select-option>
