        ...
        >
            ...
            <div style="display: flex; justify-content: space-between;">
                ...
                >
                    ...
                    <a-select-option value="7"> 客户级别 </a-select-option>
                    <a-select-option value="8"> 客户来源 </a-select-option>
                    <a-select-option value="9"> 客户行业 </a-select-option>
                    <a-select-option value="10"> 成交状态 </a-select-option>
                    <a-select-option value="11"> 最后跟进时间 </a-select-option>
                    <a-select-option value="12"> 更新时间 </a-select-option>
                    <a-select-option value="13"> 创建时间 </a-select-option>
                    <a-select-option value="14"> 创建人 </a-select-option>
                </a-select>
                <div>包含</div>
                <a-input
                    style="width: 293px;"
