<template>
    <div>
        ...
        >
            ...
            <div style="margin-top: 20px;">同时添加至：</div>
            <a-checkbox-group style="margin-left: 10px;" v-model="addother">
                <a-row>
                    <a-col :span="20">
                        <a-checkbox value="1"> 商机 </a-checkbox>
                    </a-col>
                    <a-col :span="20">
                        <a-checkbox value="2"> 合同 </a-checkbox>
                    </a-col>
                </a-row>
            </a-checkbox-group>
        </a-modal>
