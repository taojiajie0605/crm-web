    ...
    <div>
        ...
        >
            ...
            <div style="display: flex; justify-content: space-between;">
                ...
                >
                    <a-select-option value="1"> 商机名称 </a-select-option>
                    <a-select-option value="2"> 客户名称 </a-select-option>
                    <a-select-option value="3"> 商机金额 </a-select-option>
                    <a-select-option value="4"> 预计成交日期 </a-select-option>
                    <a-select-option value="5"> 备注 </a-select-option>
                    <a-select-option value="6"> 商机状态组 </a-select-option>
                    <a-select-option value="7"> 最后跟进时间 </a-select-option>
                    <a-select-option value="8"> 负责人 </a-select-option>
                    <a-select-option value="9"> 创建人 </a-select-option>
                    <a-select-option value="10"> 更新时间 </a-select-option>
                    <a-select-option value="11"> 创建时间 </a-select-option>
                </a-select>
                <div>包含</div>
                <a-input
                    style="width: 293px;"
