                ...
                <div>
                    ...
                    >
                        <a-menu-item
                            ...
                            :key="item"
                            style="height: 55px; color: black; margin: 0px;"
                        >
                            <div
...
export default {
    ...
    data() {
        return {
            ...
            checkAll1: false, //框全选
            plainOptions1: ['查看', '编辑'], //一共多少选项
            plainOptions2: ['查看', '停用/启用'], //一共多少选项
            plainOptions3: [
                '部门/员工查看',
                '员工新建',
                '员工禁用/激活',
            ...
            plainOptions4: ['角色权限设置'], //一共多少选项
            plainOptions5: ['办公审批管理'], //一共多少选项
            plainOptions6: ['审批流程管理'], //一共多少选项
            plainOptions7: [
                '自定义字段设置',
                '客户公海规则',
                '业务参数设置',
            ...
            plainOptions8: ['项目管理'], //一共多少选项
            plainOptions9: ['小程序管理'], //一共多少选项
            plainOptions10: ['系统登录日志', '数据操作日志', '系统登录日志'], //一共多少选项
        };
    },
    ...
    methods: {
        ...
        fetch(params = {}) {
            ...
            this.loading = true;
            request('/RoleSystemManage', METHOD.POST, {
                ...params,
            }).then((data) => {
        ...
        fetchadd(params = {}) {
            console.log('params:', params);
            this.loading = true;
            request('/RoleSystemManageadd', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
        ...
        fetchmodify(params = {}) {
            //console.log('params:', params);
            this.loading = true;
            request('/RoleSystemManagemodify', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
        ...
        fetchcopy(params = {}) {
            //console.log('params:', params);
            this.loading = true;
            request('/RoleSystemManagecopy', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
        ...
        fetchdelete(params = {}) {
            //console.log('params:', params);
            this.loading = true;
            request('/RoleSystemManagedelete', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
        ...
        fetchdeleteonerecord(params = {}) {
            //console.log('params:', params);
            this.loading = true;
            request('/RoleSystemManagedeleteonerecord', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
        ...
        fetchaddstaff(params = {}) {
            //console.log('params:', params);
            this.loading = true;
            request('/RoleSystemManageaddstaff', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
