        ...
        <a-col :span="19">
            ...
            <a-tabs style="background-color: white;" type="line" size="large">
                <a-tab-pane key="1">
                    ...
                    <div align="left" style="float: left; margin-left: 15px;">
                        <a-alert
                            v-if="this.currentitem === '项目管理员'"
                            style="width: 600px;"
                            message="项目管理员拥有“项目管理”模块所有权限，能看到并维护所有项目信息"
                            type="warning"
                            show-icon
                        />
                    </div>
                ...
                <a-tab-pane v-if="this.currentitem !== '项目管理员'" key="2">
                    <span slot="tab">
                        <div style="font-size: 14px;">
                            角色权限
                        </div>
...
export default {
    ...
    methods: {
        ...
        fetch(params = {}) {
            ...
            this.loading = true;
            request('/RoleProjManage', METHOD.POST, {
                ...params,
            }).then((data) => {
        ...
        fetchadd(params = {}) {
            console.log('params:', params);
            this.loading = true;
            request('/RoleProjManageadd', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
        ...
        fetchmodify(params = {}) {
            //console.log('params:', params);
            this.loading = true;
            request('/RoleProjManagemodify', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
        ...
        fetchcopy(params = {}) {
            //console.log('params:', params);
            this.loading = true;
            request('/RoleProjManagecopy', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
        ...
        fetchdelete(params = {}) {
            //console.log('params:', params);
            this.loading = true;
            request('/RoleProjManagedelete', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
        ...
        fetchdeleteonerecord(params = {}) {
            //console.log('params:', params);
            this.loading = true;
            request('/RoleProjManagedeleteonerecord', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
        ...
        fetchaddstaff(params = {}) {
            //console.log('params:', params);
            this.loading = true;
            request('/RoleProjManageaddstaff', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
