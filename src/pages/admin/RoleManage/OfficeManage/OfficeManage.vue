...
export default {
    ...
    data() {
        return {
            ...
            checkAll1: false, //框全选
            plainOptions1: ['查看'], //一共多少选项
            plainOptions2: ['新建', '编辑', '删除'], //一共多少选项
            plainOptions3: ['查看'], //一共多少选项
        };
    },
    ...
    methods: {
        ...
        fetch(params = {}) {
            ...
            this.loading = true;
            request('/RoleOfficeManage', METHOD.POST, {
                ...params,
            }).then((data) => {
        ...
        fetchadd(params = {}) {
            console.log('params:', params);
            this.loading = true;
            request('/RoleOfficeManageadd', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
        ...
        fetchmodify(params = {}) {
            //console.log('params:', params);
            this.loading = true;
            request('/RoleOfficeManagemodify', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
        ...
        fetchcopy(params = {}) {
            //console.log('params:', params);
            this.loading = true;
            request('/RoleOfficeManagecopy', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
        ...
        fetchdelete(params = {}) {
            //console.log('params:', params);
            this.loading = true;
            request('/RoleOfficeManagedelete', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
        ...
        fetchdeleteonerecord(params = {}) {
            //console.log('params:', params);
            this.loading = true;
            request('/RoleOfficeManagedeleteonerecord', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
        ...
        fetchaddstaff(params = {}) {
            //console.log('params:', params);
            this.loading = true;
            request('/RoleOfficeManageaddstaff', METHOD.POST, {
                ...params,
            }).then((data) => {
                //console.log('data:', data);
                const pagination = { ...this.pagination };
